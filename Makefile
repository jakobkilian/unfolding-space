CC = g++
CCFLAGS = -o3 -O -g -pthread -Wno-psabi
SOURCES = glove.cpp camera.cpp poti.cpp init.cpp timelog.cpp udp.cpp monitoring.cpp main.cpp 
NAME = unfolding-app
...
run: $(NAME)
	LD_LIBRARY_PATH=/home/dietpi/libroyale/bin ./unfolding-app $(ARGS)
